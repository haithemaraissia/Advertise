...
{
    public partial class AdvertiserReportCurrentGeographic : Page
    {
        ...
        protected void ViewAllAdImageButtonClick(object sender, ImageClickEventArgs e)
        {
            dsdetails.SelectCommand =
                ...
                Utility.GetUserID() + "' AND AdGeneral.IsActive = 1 AND AdGeneral.Completed = 0 ORDER BY AdStats.EntryDate";
            gvdetails.DataBind();
