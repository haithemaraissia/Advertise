<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Platform.aspx.cs" Inherits="Advertiser.Report.Completed.AdvertiserReportCompletedPlatform" %>
...
<head id="Head1" runat="server">
    ...
    <title id="AdvertiserTitle" runat="server" title="<%$ Resources:Resource, PlatformReport %>">
    </title>
                    ...
                    <div>
                        ...
                        <div id="PrintView">
                                    ...
                                    <td>
                                        <p align="center" style="color: rgb(0, 0, 0); font-family: 'Times New Roman'; font-size: medium;
                                            ...
                                            <font face="Arial" size="3"><b>
                                                <br />
                                                <asp:Label ID="VisitorDemographicLabel" runat="server" Text="<%$ Resources:Resource, VisitorsPlatform %>"></asp:Label>
                                                <br />
                                            </b>
                                                <br />
                            ...
                            <asp:SqlDataSource ID="dsdetails" runat="server" ConnectionString="<%$  ConnectionStrings:AdDatabaseConnectionString1 %>"
                                SelectCommand="SELECT DISTINCT TOP (10000) AdGeneral.AdName, AdStats.EntryDate, AdGeneral.ImageUrl, VisitorPlatform.AdId, VisitorPlatform.BrowserType, VisitorPlatform.BrowserName, VisitorPlatform.BrowserPlatform, VisitorPlatform.DeviceType, VisitorPlatform.UserLanguage, VisitorPlatform.MobileDeviceModel  FROM  AdGeneral INNER JOIN AdStats ON AdGeneral.AdID = AdStats.AdId INNER JOIN VisitorPlatform ON AdGeneral.AdID = VisitorPlatform.AdId WHERE (AdGeneral.Completed = 1) AND (AdGeneral.UserID = @UserID) AND (AdGeneral.IsActive = 0) ORDER BY AdStats.EntryDate">
                                <SelectParameters>
