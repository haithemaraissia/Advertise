<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateAd.aspx.cs" Inherits="Admanagment.Advertiser.CreateAd" %>
...
<head id="Head1" runat="server">
    <title id="Title1" runat="server" title="<%$ Resources:Resource, CreateAd %>"></title>
                    ...
                    <table style="font-size: 10pt; font-family: Verdana; text-align: center" width="820"
                        ...
                        <tr>
                            <td class="HalfWidth">
                                ...
                                <asp:ValidatorCalloutExtender ID="AsyncFileUploadValidatorCalloutExtender" runat="server"
                                    TargetControlID="AsyncFileUploadCustomValidator">
                                </asp:ValidatorCalloutExtender>
                            </td>
                            <td>
                                &nbsp;
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:Button ID="CreateAdButton" runat="server" Text="<%$ Resources:Resource, CreateAd %>"
                                    Width="121px" OnClick="CreateAdButtonClick" />
                            </td>
                        </tr>
                    </table>
