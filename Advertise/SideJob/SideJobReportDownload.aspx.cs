...
public partial class SideJobReportDownload : Page
{
            ...
            if (Session["LCID"] != null)
            {
                ...
                Thread.CurrentThread.CurrentCulture =
                    CultureInfo.CreateSpecificCulture(
                        Admanagment.Helpers.Utility.GetLanguage(Convert.ToInt32(Session["LCID"])));
            }
        }
    }
            ...
            if (contract != null)
            {
                ...
                if (archivedprojectrequirement != null)
                {
                    ...
                    ProjectExperience.Text =
                        GetExperience(experienceID, Convert.ToInt32(Session["LCID"].ToString())).ToString(
                            CultureInfo.InvariantCulture);
                    ProjectCrewNumber.Text =
                        GetCrewnumber(crewnumberID, Convert.ToInt32(Session["LCID"].ToString())).ToString(
                            CultureInfo.InvariantCulture);
                    ProjectLicensed.Text =
                        GetLicensed(licensedID, Convert.ToInt32(Session["LCID"].ToString())).ToString(
                            CultureInfo.InvariantCulture);
                    ProjectInsured.Text =
                        GetInsured(insuredID, Convert.ToInt32(Session["LCID"].ToString())).ToString(
                            CultureInfo.InvariantCulture);
                    ProjectRelocation.Text =
                        GetInsured(relocationID, Convert.ToInt32(Session["LCID"].ToString())).ToString(
                            CultureInfo.InvariantCulture);
                    ...
                    var projectlocation = projectcountry.ToString(CultureInfo.InvariantCulture) + "/" + projectregion + "/" +
                                          projectcity.ToString(CultureInfo.InvariantCulture);
    ...
    {
        const string noprojectimagepath =
    ...
    protected void Page2()
    {
        ...
        var engagmentperformance = "<div align='left'><b>" +
                                   Resources.Resource.EngagmentandPerformanceofServicesPart1Label + "</b></div>";
        ...
        var changecontrol = "<div align='left'><b>" + Resources.Resource.ChangeControlLabelPart1 +
                            "</b><br/>" + Resources.Resource.ChangeControlLabelPart2 +
                            Resources.Resource.ChangeControlLabelPart3 + "</div>";
        ...
        var independentContractorRelationship = "<div align='left'><b>" +
                                                Resources.Resource.IndependentContractorRelationshipPart1Label +
                                                "</b><br/>" +
                                                Resources.Resource.IndependentContractorRelationshipPart2Label +
                                                "</div>";
    ...
    protected void Page3()
    {
        ...
        var licensedtobackgroundtechnology = "<div align='left'><b>" +
                                             Resources.Resource.LicensetoBackgroundTechnologyPart1Label +
                                             "</b><br/>" + Resources.Resource.LicensetoBackgroundTechnologyPart2Label +
                                             "</div>";
        LicenseToBackgroundTechnology.Text = licensedtobackgroundtechnology;

        var ownershipandassignmentofworkproduct = "<div align='left'><b>" +
                                                  Resources.Resource.OwnershipandAssignmentofWorkProductPart1Label +
                                                  "</b><br/>" +
                                                  Resources.Resource.OwnershipandAssignmentofWorkProductPart2Label +
                                                  "</div>";
        OwnershipandAssignmentofWorkProduct.Text = ownershipandassignmentofworkproduct;

        var licensetorwaiverofotherrRights = "<div align='left'><b>" +
                                             Resources.Resource.LicensetoorWaiverofOtherRightsPart1Label +
                                             "</b><br/>" + Resources.Resource.LicensetoorWaiverofOtherRightsPart2Label +
                                             "</div>";
        ...
        var competitiveorconflictingprojects = "<div align='left'><b>" +
                                               Resources.Resource.CompetitiveorConflictingProjectsPart1Label +
                                               "</b><br/>" +
                                               Resources.Resource.CompetitiveorConflictingProjectsPart2Label + "</div>";
        ...
        var serviceproviderrepresentationsandwarranties = "<div align='left'><b>" +
                                                          Resources.Resource.
                                                              ServiceProviderRepresentationsandWarrantiesPart1Label +
                                                          "</b><br/>" +
                                                          Resources.Resource.
                                                              ServiceProviderRepresentationsandWarrantiesPart2Label +
                                                          "</div>";
        ...
        var mutiemployeeserviceprovider = "<div align='left'><b>" +
                                          Resources.Resource.MutiEmployeeServiceProviderPart1Label +
                                          "</b><br/>" + Resources.Resource.MutiEmployeeServiceProviderPart2Label +
                                          "</div>";
    ...
    protected void Page5()
    {
        ...
        var betweenparty = "<div align='left'><b>" + Resources.Resource.BetweenLabel + "</b>" +
                           Resources.Resource.PartyALabel + Resources.Resource.PartyA + Resources.Resource.PartyBLabel
                           + Resources.Resource.PartyB + Resources.Resource.PartyAB + "</div>";

        BetweenParty.Text = betweenparty;

        var recitals = "<div align='left'><b>" + Resources.Resource.RecitalsPart1Label + "</b><br/>" +
                       Resources.Resource.RecitalsPart2Label + "</div>";
        ...
        var operativeprovisionspart2 = "<div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
                                       Resources.Resource.OneLabel + "." +
                                       Resources.Resource.OperativeProvisionsPart2Label + "</div>";

        OperativeProvisionsPart2.Text = operativeprovisionspart2;

        var operativeprovisionspart3 = "<div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
                                       Resources.Resource.TwoLabel + "." +
                                       Resources.Resource.OperativeProvisionsPart3Label + "</div>";

        OperativeProvisionsPart3.Text = operativeprovisionspart3;

        var operativeprovisionspart4 = "<div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
                                       Resources.Resource.ThreeLabel + "." +
                                       Resources.Resource.OperativeProvisionsPart4Label + "</div>";

        OperativeProvisionsPart4.Text = operativeprovisionspart4;

        var operativeprovisionspart5 = "<div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
                                       Resources.Resource.FourLabel + "." +
                                       Resources.Resource.OperativeProvisionsPart5Label + "</div>";

        OperativeProvisionsPart5.Text = operativeprovisionspart5;

        var operativeprovisionspart6 = "<div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
                                       Resources.Resource.FiveLabel + "." +
                                       Resources.Resource.OperativeProvisionsPart6Label + "</div>";

        OperativeProvisionsPart6.Text = operativeprovisionspart6;

        var operativeprovisionspart7 = "<div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
                                       Resources.Resource.SixLabel + "." +
                                       Resources.Resource.OperativeProvisionsPart7Label + "</div>";

        OperativeProvisionsPart7.Text = operativeprovisionspart7;

        var operativeprovisionspart8 = "<div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
                                       Resources.Resource.SevenLabel + "." +
                                       Resources.Resource.OperativeProvisionsPart8Label + "</div>";
