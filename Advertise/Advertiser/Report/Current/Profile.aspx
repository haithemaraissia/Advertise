<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Profile.aspx.cs" Inherits="Advertiser.Report.Current.AdvertiserReportCurrentProfile" %>
...
<head id="Head1" runat="server">
    ...
    <title id="AdvertiserTitle" runat="server" title="<%$ Resources:Resource, ProfileReport %>">
    </title>
                                    ...
                                    <td>
                                        <p align="center" style="color: rgb(0, 0, 0); font-family: 'Times New Roman'; font-size: medium;
                                            ...
                                            <font face="Arial" size="3"><b>
                                                <br />
                                                <asp:Label ID="VisitorProfileLabel" runat="server" Text="<%$ Resources:Resource, VisitorsProfile %>"></asp:Label>
                                                <br />
                                            </b>
                                                <br />
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView runat="server" ID="gvdetails" DataSourceID="dsdetails" AllowPaging="True"
                                            ...
                                            ForeColor="#333333" GridLines="None" Style="text-align: center" OnRowDataBound="GvdetailsRowDataBound">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField SortExpression="IndustryID">
                                                    <ItemTemplate>
