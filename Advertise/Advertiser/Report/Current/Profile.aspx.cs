...
{
    public partial class AdvertiserReportCurrentProfile : Page
    {
        ...
        protected void ViewAllAdImageButtonClick(object sender, ImageClickEventArgs e)
        {
            dsdetails.SelectCommand =
                ...
                "INNER JOIN VisitorInfo ON AdGeneral.AdID = VisitorInfo.AdId  WHERE AdGeneral.UserID = '" + Utility.GetUserID() + "' AND AdGeneral.IsActive = 1 AND " +
                "AdGeneral.Completed = 0 ORDER BY AdStats.EntryDate";
            gvdetails.DataBind();
