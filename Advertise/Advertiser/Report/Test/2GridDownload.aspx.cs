...
{
    public partial class _2GridDownload : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            sb.Append(myString);
            sb.Insert(0,
                      "<div>  <p style='color: #800000; text-align:center'><strong>EXECUTIVE REPORT</strong></p><div><br/><br/>");
            ...
            myString = myString.Replace("../Advertiser/Ads/", myString2);
            //myString = Strings.Replace(myString, "<th", "<th align='center'");

            ///  The next 4 lines made it work////


            var str = new StringReader(myString);
            pdfDoc.Open();
