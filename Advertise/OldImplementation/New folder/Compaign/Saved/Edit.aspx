<%@ Page Title="" Language="C#" MasterPageFile="~/Plain.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Advertiser_Compaign_Saved_Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 FROM AdAudience INNER JOIN AdGeneral ON AdAudience.AdID = AdGeneral.AdID WHERE AdGeneral.IsActive = 0"></asp:SqlDataSource>
    </asp:Panel>
