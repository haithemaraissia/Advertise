...
{
    public partial class AdvertiserReportCurrentPlatform : Page
    {
        ...
        protected void ViewAllAdImageButtonClick(object sender, ImageClickEventArgs e)
        {
            dsdetails.SelectCommand =
                ...
                "WHERE AdGeneral.UserID = '" + Utility.GetUserID() + "' AND AdGeneral.IsActive = 1 AND AdGeneral.Completed = 0 ORDER BY AdStats.EntryDate";
            gvdetails.DataBind();
