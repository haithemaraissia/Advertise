...
public partial class Authenticated_Customer_Paypal_Handler : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int p = Request.QueryString.Count;

        if ( p == 0)
        {
            string test2 =
            "mc_gross=760.50&protection_eligibility=Eligible&address_status=confirmed&payer_id=ZWBS2MSEVB88G&tax=0.00&address_street=1 Main St&payment_date=23:44:47 Aug 16, 2012 PDT&payment_status=Completed&charset=windows-1252&address_zip=95131&first_name=customer&mc_fee=22.35&address_country_code=US&address_name=customer lastname&notify_version=3.6&custom=5&payer_status=verified&business=admin_1329938514_biz@yahoo.com&address_country=United States&address_city=San Jose&quantity=1&verify_sign=AFcWxV21C7fd0v3bYYYRCpSSRl31ALkpNqERT7VKoCjBl5P61K1VLYuP&payer_email=cust_1329938730_per@yahoo.com&txn_id=86690895044266640&payment_type=instant&last_name=lastname&address_state=CA&receiver_email=admin_1329938514_biz@yahoo.com&payment_fee=22.35&receiver_id=SK9ERCZBAX23S&txn_type=web_accept&item_name=fgf&mc_currency=USD&item_number=&residence_country=US&test_ipn=1&handling_amount=0.00&transaction_subject=5&payment_gross=760.50&shipping=0.00&ipn_track_id=a2d53d8a317f9";

            string r = HttpContext.Current.Request.Url.AbsoluteUri + "?" + test2;
            Response.Redirect(r);
        }
        ...
        IPNHolder pdt = IPNHolder.Parse(test);
