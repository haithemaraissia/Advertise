...
public partial class GoogleNewsSerialize : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        GoogleNewsSiteMap2 googleNewsSiteMap = new GoogleNewsSiteMap2();
...
public class GoogleNewsSiteMap2
{
    ...
    public string GetXMLString()
    {
        ...
        using (XmlWriter writer = XmlWriter.Create(str, settings))
        {
            ...
            XmlSerializer xser = new XmlSerializer(typeof(GoogleNewsSiteMap2));
