...
public partial class Advertiser_Compaign_Completed_Inventory : System.Web.UI.Page
{
    ...
    protected void AdGridViewSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect(string.Format("ChangeAd.aspx?ID={0}&P=Completed", AdGridView.SelectedDataKey.Value));
        }
    }
}