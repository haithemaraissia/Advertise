<%@ Page Title="" Language="C#" MasterPageFile="~/Plain.master" AutoEventWireup="true"
    CodeFile="Delete.aspx.cs" Inherits="Advertiser_DeleteAd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="AdListPanel" runat="server" Height="649px" Style="position: relative;
        ...
        <asp:GridView runat="server" ID="AdGridView" DataSourceID="AdSqlDataSource" AllowPaging="True"
            ...
            OnRowDataBound="AdGridViewRowDataBound" PageSize="4">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="StartDate" HeaderText="<%$ Resources:Resource, Start %>"
                    SortExpression="StartDate" DataFormatString="{0:MM/dd/yyyy}" HtmlEncode="false" />
                <asp:BoundField DataField="EndDate" HeaderText="<%$ Resources:Resource, End %>" SortExpression="EndDate"
                ...
                <asp:ButtonField CommandName="delete" Text="<%$ Resources:Resource, Delete %>" ButtonType="Button"></asp:ButtonField>
            </Columns>
        ...
        <asp:SqlDataSource ID="AdSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:AdDatabaseConnectionString1 %>"
            SelectCommand="SELECT AdAudience.AdID, AdGeneral.AdName, AdGeneral.ImageUrl, AdGeneral.StartDate, AdGeneral.EndDate, AdAudience.CountryName,AdAudience.FlagPath, AdAudience.CountryCode
 FROM AdAudience INNER JOIN AdGeneral ON AdAudience.AdID = AdGeneral.AdID WHERE (AdGeneral.IsActive = 0) AND (AdGeneral.Completed = 1) AND (AdGeneral.UserID = @UserID)"
