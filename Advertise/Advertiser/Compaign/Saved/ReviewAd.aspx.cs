...
public partial class Advertiser_Compaign_Saved_ReviewAd : System.Web.UI.Page
{
    ...
    protected void PlaceAdButtonClick(object sender, EventArgs e)
    {
        ...
        if (AlreadyExist())
        {
            Response.Redirect(string.Format("../Payment/PayPal/PDT/PDTStart.aspx?ID={0}&AD=" + GetAdGeneralAdID(), GetSavedPaymentID()));
        }else
        {


            Response.Redirect(string.Format("../Payment/PayPal/PDT/PDTStart.aspx?ID={0}&AD=" + GetAdGeneralAdID(), (Admanagment.Helpers.Utility.GetPaymentID() - 1)));
        }
    }
