<%@ Page Title="" Language="C#" MasterPageFile="~/Plain.master" AutoEventWireup="true" CodeFile="Help.aspx.cs" Inherits="Admanagment.Help" %>
...
<asp:accordion ID="Accordion1" runat="server" SelectedIndex="0" FadeTransitions="true"
        ...
        AutoSize="None" HeaderCssClass="AccordionHeader"
                            ...
                            ContentCssClass="AccordionContent" Height="528px" 
        Width="820px" >
                            <Panes>
                                <asp:AccordionPane runat="server" ID="sfewrfw">
                                    <Header>
                                    ...
                                    <Content>
                                        <div>
                                            <p class="SmallP">
                                                ...
                                                <br />
                                                &nbsp;&nbsp;&nbsp; VMC can be <a href="../../WIP2/NotAuthenticated/Customize.aspx" title="Customize Product"
