...
public partial class Advertiser_Profile_ViewProfile : System.Web.UI.Page
{
    ...
    protected void GetAttributes()
    {
        ...
        Industry.Text = Admanagment.Helpers.Utility.GetIndustryById(Convert.ToInt32(Profile.Industry), Convert.ToInt32(Session["LCID"].ToString()));
        ...
        CountryImage.ImageUrl = Admanagment.Helpers.Utility.GetFlagPath(Profile.CountryID);
