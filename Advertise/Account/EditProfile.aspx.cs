...
public partial class Account_EditProfile : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect(Admanagment.Helpers.Utility.Login());
        }
    ...
    protected void SaveAttributes()
    {
        ...
        Profile.Profession = Admanagment.Helpers.Utility.GetProfession(SpecialityListBox1, SpecialityListBox2, SpecialityListBox3);
        Profile.ProfessionID = Admanagment.Helpers.Utility.GetProfessionID(SpecialityListBox1, SpecialityListBox2, SpecialityListBox3);
