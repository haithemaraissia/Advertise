...
{
    public partial class AdvertiserReportCompletedPlatform : Page
    {
        ...
        protected void ValidateAdvertiser()
        {
            ...
            if (user == null)
            {
                Response.Redirect("../../../Account/Login.aspx?ReturnUrl=../Advertiser/Report/Current/Platform.aspx");
            }
        }
        ...
        protected void FilterButtonClick(object sender, EventArgs e)
        {
            ...
            dsdetails.SelectCommand =
                "SELECT DISTINCT TOP (10000) AdGeneral.AdName, AdStats.EntryDate, AdGeneral.ImageUrl, VisitorPlatform.AdId, VisitorPlatform.BrowserType, " +
                "VisitorPlatform.BrowserName, VisitorPlatform.BrowserPlatform, VisitorPlatform.DeviceType, VisitorPlatform.UserLanguage, " +
                "VisitorPlatform.MobileDeviceModel FROM  AdGeneral INNER JOIN AdStats ON AdGeneral.AdID = AdStats.AdId INNER JOIN VisitorPlatform ON " +
                "AdGeneral.AdID = VisitorPlatform.AdId WHERE (AdStats.EntryDate BETWEEN '" + t2 + "' AND '" + t + "') AND AdGeneral.UserID = '" + Utility.GetUserID() +
        ...
        protected void PDFButtonClick(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("IFrame/PlatformDownload.aspx?t1=" + t + "&t2=" + t2);
        }
        ...
        protected void ViewAllAdImageButtonClick(object sender, ImageClickEventArgs e)
        {
            dsdetails.SelectCommand =
                ...
                "WHERE AdGeneral.UserID = '" + Utility.GetUserID() + "' AND AdGeneral.IsActive = 0 AND AdGeneral.Completed = 1 ORDER BY AdStats.EntryDate";
            gvdetails.DataBind();
