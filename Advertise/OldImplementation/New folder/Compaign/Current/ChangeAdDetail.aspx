<%@ Page  Language="C#" AutoEventWireup="true" CodeFile="ChangeAdDetail.aspx.cs" Inherits="Advertiser_ChangeAdDetail" %>
...
<body>
    ...
    <table style="font-size: 10pt; font-family: Verdana; text-align: center" width="820"
                                                        ...
                                                        <tr align="center">
                                                            ...
                                                            <td>
                                                                <asp:Button ID="UpdateAdButton" runat="server" Text="<%$ Resources:Resource, UpdateAd %>"
                                                                    Width="121px" onclick="UpdateAdButtonClick" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ContentTemplate>
        ...
        <div id="footer">
            <LowerNavigationButtons:NavigationButtons ID="NavigationButtons1" runat="server" />
        </div>
    </div>
    </form>
</body>
