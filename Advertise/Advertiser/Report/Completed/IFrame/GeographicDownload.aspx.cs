...
{
    public partial class AdvertiserReportCompletedIFrameGeographicDownload : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(t1) && !string.IsNullOrEmpty(t2))
            {
                ...
                "' AND (AdGeneral.Completed = 1) And (AdGeneral.IsActive = 0) ORDER BY AdStats.EntryDate";
            }
            else
            {
        ...
        public void PrintPDF()
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=GeographicReport.pdf");
