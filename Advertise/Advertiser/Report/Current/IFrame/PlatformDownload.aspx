<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlatformDownload.aspx.cs"
    Inherits="Advertiser.Report.Current.IFrame.AdvertiserReportCurrentIFramePlatformDownload"
    ...
    <div id="Div1" runat="server">
        ...
        <asp:SqlDataSource ID="dsdetails" runat="server" ConnectionString="<%$  ConnectionStrings:AdDatabaseConnectionString1 %>"
            SelectCommand="SELECT DISTINCT TOP (10000) AdGeneral.AdName, AdStats.EntryDate, AdGeneral.ImageUrl, VisitorPlatform.AdId, VisitorPlatform.BrowserType,
                         ...
                         WHERE (AdGeneral.Completed = 0) AND (AdGeneral.UserID = @UserID) AND (AdGeneral.IsActive = 1) ORDER BY AdStats.EntryDate">
            <SelectParameters>
