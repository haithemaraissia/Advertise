<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AudienceDemographic.aspx.cs" Inherits="Admanagment.Advertiser.IFrame.AudienceDemographic" %>
...
<form id="form1" runat="server">
    <div>
        ...
        <asp:SqlDataSource ID="dsdetails" runat="server" ConnectionString="<%$ ConnectionStrings:AdDatabaseConnectionString1 %>"
                           ...
                           SelectCommand="SELECT AdGeneral.AdName, AdGeneral.ImageUrl, VisitorGeo.CountryName, VisitorGeo.Region, VisitorGeo.CityName, VisitorGeo.PostalCode, VisitorGeo.AreaCode, VisitorGeo.MetroCode, AdAudience.AdID, AdGeneral.StartDate, AdGeneral.EndDate, AdGeneral.UserID FROM AdAudience INNER JOIN AdGeneral ON AdAudience.AdID = AdGeneral.AdID INNER JOIN VisitorGeo ON AdAudience.AdID = VisitorGeo.AdId WHERE (AdGeneral.IsActive = 1) AND (AdGeneral.UserID = '79683b62-12e0-416e-a5eb-8bb81463e805') ORDER BY AdAudience.AdID"></asp:SqlDataSource>
    </div>
    <br />
    <table width="830px" style="background-color: red">
        <tr>
            <td>
                \nd Clause to determine which ad are quered&nbsp; for the AdvertiserID ( UserID)</td>
        </tr>
    </table>
</form>